...
const TvDetails = () => {
  ...
  return info ? (
    <div
      ...
      className="relative w-screen h-[220vh] px-[10%] py-10"
    >
      {/* Navigation bar */}
      ...
      <div className="w-[100%] flex overflow-y-hidden mb-5 p-5">
        {info.detail.seasons.length > 0 ? (
          info.detail.seasons.map((s, i) => (
            <div key={i} className="mr-[20px]">
              <img
                className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] min-w-[14vw] h-[43vh] object-cover rounded-md"
